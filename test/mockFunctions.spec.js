// Mockeando todas as funções da lib/pasta mockFunction
jest.mock('../src/mockFunctions');
// Trazendo as funções e usando o destruction object
const {
  add,
  subtract,
  multiply,
...
const fatorialFunc = (a) => {
  ...
  return a * fatorialFunc(a - 1);
};

describe('verifica as funções e os mocks', () => {
  // Crie suas mock functions aqui
  // Abaixo estão as funçoes 'mockeadas' e a implementação deles;
  power.mockImplementation((a, b) => a ** b);
  multiply.mockImplementation((a, b) => a * b);
  subtract.mockImplementation((a, b) => a - b);
  factorial.mockImplementation((a) => fatorialFunc(a));
