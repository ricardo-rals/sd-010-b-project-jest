...
// Mock com implementation https://jestjs.io/pt-BR/docs/mock-function-api
  ...
  mockFunctions.factorial = jest.fn().mockImplementation((a) => {
    // Função factorial https://www.freecodecamp.org/news/how-to-factorialize-a-number-in-javascript-9263c89a4b38/
    if (a === 0 || a === 1) return 1;
