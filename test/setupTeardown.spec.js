...
describe('quem sobreviveu?', () => {
  ...
  afterAll(() => {
    const survivor = adventure.specialists[0].nome;
    const level = adventure.specialists[0].classe;
    const message = `${survivor}, o ${level}, foi o único sobrevivente da batalha!`;
    console.log(message);
  });
